...
if __name__ == '__main__':
    extractor = RadiomicsFeatureExtractor(r'D:\Project\SHZL\exampleCT.yaml',
                                          has_label=False)
    extractor.Execute(r'Z:\SongYang\all_format',
                      # key_name_list=['arterial'],
                      # roi_key=['arterial', 'label'],
                      key_name_list=['new_venous.nii'],
                      roi_key=['new_venous_label'],
                      store_path=r'Z:\SongYang\feature_csv\venous\venous.csv')
