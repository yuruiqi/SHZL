...
if __name__ == '__main__':
    extractor = RadiomicsFeatureExtractor(r'H:\SHZL\exampleCT.yaml',
                                          has_label=False)
    extractor.Execute(r'H:\SHZL\data\group2',

                      # key_name_list=['arterial'],
                      # roi_key=['arterial', 'label'],
                      # store_path = r'Z:\SongYang\feature_csv\arterial\arterial.csv'

                      key_name_list=['venous.nii'],
                      roi_key=['venous_label'],
                      store_path=r'D:\PycharmProjects\learning\SHZL\feature_data\group2\venous.csv'

                      # key_name_list = ['non_contrast.nii'],
                      # roi_key = ['non_contrast_label'],
                      # store_path = r'Z:\SongYang\feature_csv\non_contrast\non_contrast.csv'
                      )
